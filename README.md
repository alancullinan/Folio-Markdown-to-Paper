...
- **Preview caret:** a thin green caret mirrors the editor cursor in rendered text. It follows clicks, arrow keys, and completed preview updates, and is hidden for selections, off-screen text, and printing.
